...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Small screen */}
      <div className="pb-36 text-gray-400 pr-2 text-md font-medium border-gray-900 overflow-y-scroll scrollbar-hide h-full max-w-[8rem] sm:hidden inline-flex">
        <div className="w-[21rem]">
          ...
          <div className=" bg-[#121212] rounded-lg mt-2 h-full pt-5">
            <div className="flex space-x-2 px-4">
              <div className="bg-[#2A292A] text-white items-center justify-center rounded-3xl text-center flex px-2 py-1 text-sm">
                <p className="">Categorise</p>
              </div>
            </div>
